...
### Prerequisites
To build and use Walking, you need to have a Python environment and an up-to-date Rust compiler. If you plan to train, make sure you have a GPU installed.
...
From now on, the root directory of Walking will be demonstrated as `$WALKING_ROOT`.

### Create and activate a conda env
> Working directory: `$WALKING_ROOT`
```shell
...
For Windows (MSYS2)
```shell
$ cp target/release/riichi.dll walking/libriichi.pyd
```

### Test the environment
> Working directory: `$WALKING_ROOT/walking`
```shell
$ python
...
### Build documentation
> Working directory: `$WALKING_ROOT/docs`
```shell
